                  ...
                  <div className="flex space-x-4">
                    ...
                    {(currentUser?.isAdmin || currentUser?.isSuperAdmin) && (
                      <div className="relative group hover:cursor-pointer">
                        ...
                        <div className="absolute right-0 z-10 mt-0 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden group-hover:block">
