              ...
              <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
                ...
                {!editingTeam && (
                  <button
                    ...
                    className="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded text-indigo-700 bg-indigo-100 hover:bg-indigo-200 dark:bg-muted dark:text-foreground dark:border-border dark:hover:bg-card"
                  >
